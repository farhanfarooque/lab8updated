...
public class ContactDetails implements Comparable<ContactDetails>
{
     ...
     * @throws BadDetailsException if name contains any character 
     *                             except letters and blanks
     */
    public ContactDetails(String name, String phone, String address)
    {
        ...
        if( name.chars().anyMatch(c -> !Character.isLetter(c) && !Character.isSpaceChar(c)) )
            throw new BadDetailsException("Badly formed contact name");
